...
class MFAMDH264Encoder : public MFVideoEncoder
{
public:
	/*
	Constructor
	...
	*/
	MFAMDH264Encoder(MFPipeline* pipeline, VFVideoMediaType sourceMediaType, VFMFVideoEncoderSettings settings);
	~MFAMDH264Encoder();
...
private:
	...
	*/
	...
	public:
		EncoderEventCallback(MFPipeline* pipeline, MFAMDH264Encoder *pEncoder);
